...
Route::middleware('auth:web,store')->group(function () {
    Route::get('{guard}/verify-email', EmailVerificationPromptController::class)
                ->name('verification.notice');

    Route::get('{guard}/verify-email/{id}/{hash}', VerifyEmailController::class)
    ...
    Route::put('{guard}/password', [PasswordController::class, 'update'])->name('password.update');
